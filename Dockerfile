...
RUN curl https://d1i4a15mxbxib1.cloudfront.net/api/plugins/confluentinc/kafka-connect-jdbc/versions/10.6.0/confluentinc-kafka-connect-jdbc-10.6.0.zip -o confluentinc-kafka-connect-jdbc-10.6.0.zip
RUN confluent-hub install ./confluentinc-kafka-connect-jdbc-10.6.0.zip --no-prompt

RUN curl https://d1i4a15mxbxib1.cloudfront.net/api/plugins/confluentinc/connect-transforms/versions/1.4.3/confluentinc-connect-transforms-1.4.3.zip -o confluentinc-connect-transforms-1.4.3.zip
RUN confluent-hub install ./confluentinc-connect-transforms-1.4.3.zip --no-prompt
