...
RUN sed "s@# http.proxyHost=@http.proxyHost=http://hoeprx01.na.xom.com:8080@g" /usr/lib/jvm/zulu11/conf/net.properties && \
    sed "s@# http.proxyPort=80@http.proxyPort=8080@g" /usr/lib/jvm/zulu11/conf/net.properties && \
    sed "s@# https.proxyHost=@https.proxyHost=http://hoeprx01.na.xom.com:8080@g" /usr/lib/jvm/zulu11/conf/net.properties && \
    sed "s@# https.proxyPort=443@https.proxyPort=8080@g" /usr/lib/jvm/zulu11/conf/net.properties && \
