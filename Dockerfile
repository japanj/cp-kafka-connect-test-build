...
RUN sed 's/# http.proxyHost=/http.proxyHost=http://cn-1998269054-nx10291.ibosscloud.com:80/g' /usr/lib/zulu11/conf/net.properties && \
    sed 's/# http.proxyPort=80/http.proxyPort=80/g' /usr/lib/zulu11/conf/net.properties && \
